 ...
 */
#ifndef include_math64_h
#define include_math64_h
#include <stdint.h>
 ...
 */
static inline void
mul64by64 (u64 a, u64 b, u64 * hi, u64 * lo)
{
...
static inline u64
mod128by64 (u64 x, u64 y, u64 m, double di)
{
  u64 q1, q2, q;
  u64 p1, p0;
  double dq;
 ...
 */
static inline u64
mod64by64 (u64 a, u64 p, u64 primeinv)
{
  return (mod128by64 (0, a, p, primeinv));
}

static inline void
add64 (u64 a, u64 b, u64 * whi, u64 * wlo)
{
  *wlo = a + b;
  if (*wlo < a)
    *whi = 1;
 ...
 */
static inline u64
add64_mod (u64 a, u64 b, u64 p, double pi)
{
  u64 shi = 0, slo = 0;
 ...
 */
static inline u64
mul64_mod (u64 a, u64 b, u64 p, double pi)
{
  u64 phi = 0, plo = 0;
