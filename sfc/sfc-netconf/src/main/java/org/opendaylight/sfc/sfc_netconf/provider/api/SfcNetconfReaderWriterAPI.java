 ...
 */
public class SfcNetconfReaderWriterAPI {

    private static final Logger LOG = LoggerFactory.getLogger(SfcNetconfReaderWriterAPI.class);
    public static final InstanceIdentifier<Topology> NETCONF_TOPO_IID =
            InstanceIdentifier.create(NetworkTopology.class)
                    .child(Topology.class, new TopologyKey(new TopologyId(TopologyNetconf.QNAME.getLocalName())));
    protected static MountPointService mountPointService = null;
    ...
    public static NetconfNode readNode(NodeId nodeId) {
        try {
            ...
            LOG.warn("Node {} does not exist", nodeId.getValue());
        }
        return null;
    }
