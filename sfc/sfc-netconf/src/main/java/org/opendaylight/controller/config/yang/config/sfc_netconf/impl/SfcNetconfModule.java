...
import org.opendaylight.sfc.sfc_netconf.provider.listener.SfcNetconfRIPDataListener;
...
public class SfcNetconfModule extends org.opendaylight.controller.config.yang.config.sfc_netconf.impl.AbstractSfcNetconfModule {
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        final SfcNetconfRIPDataListener sfcNetconfRIPDataListener = new SfcNetconfRIPDataListener(opendaylightSfc);
        ...
        final class AutoCloseableSfcOvs implements AutoCloseable {
            ...
            public void close() {
                ...
                sfcNetconfRIPDataListener.getDataChangeListenerRegistration().close();
/*                try {
