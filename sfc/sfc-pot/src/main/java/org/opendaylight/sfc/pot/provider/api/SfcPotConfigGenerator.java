 ...
 * @version 0.2
 * @see org.opendaylight.sfc.pot.provider.api.SfcPotConfigGenerator
 * @since 2016-05-01
 */
public class SfcPotConfigGenerator {
    ...
    final static short DEFAULT_NUM_BITS = 60;    //number of bits
    ...
    // Function to evaluate a polynomial without the constant part given the value and coefficients.
    ...
    public BigInteger[] getLpcs() {
        ...
        //BigInteger[] res = new BigInteger[lpcs.length];
        //for(int i=0;i<lpcs.length;i++) res[i] = lpcs[i];
        //return res;
        return res;
    }
