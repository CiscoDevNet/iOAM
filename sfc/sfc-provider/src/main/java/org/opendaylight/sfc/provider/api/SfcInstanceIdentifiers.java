...
import org.opendaylight.yang.gen.v1.urn.cisco.params.xml.ns.yang.ioam.path.rev151129.RenderedIoamPaths;
import org.opendaylight.yang.gen.v1.urn.cisco.params.xml.ns.yang.ioam.path.rev151129.rendered.ioam.paths.RenderedIoamPath;
...
public class SfcInstanceIdentifiers implements AutoCloseable {
    ...
    public static final InstanceIdentifier<RenderedIoamPath> RIP_ENTRY_IID =
            InstanceIdentifier.builder(RenderedIoamPaths.class).child(RenderedIoamPath.class).build();
