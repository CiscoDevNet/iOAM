...
import org.opendaylight.yang.gen.v1.urn.cisco.params.xml.ns.yang.ioam.path.rev151129.RenderedIoamPathService;
...
public class SfcProviderModule extends org.opendaylight.controller.config.yang.config.sfc_provider.impl.AbstractSfcProviderModule {
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        final BindingAwareBroker.RpcRegistration<RenderedIoamPathService> ripRpcRegistration =
                getRpcRegistryDependency()
                        .addRpcImplementation(RenderedIoamPathService.class,
                                sfcProviderRpc);
